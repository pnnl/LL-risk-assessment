...
outFile = OUTPUT_Folder + '\\' + 'MiniWECC240_SquareWave_load_Var_'+str(load_bus_number)+'_'+str(load_bus_name_)+'.out' 
csvFile = OUTPUT_Folder + '\\' +  'MiniWECC240_SquareWave_load_Var_'+str(load_bus_number)+'_'+str(load_bus_name_)+'.csv' 
